...
const CreateGroup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(`https://server-pyv6.onrender.com/api/create-group`, {
        method: 'POST',
      ...
      if (data.insertedId || data.acknowledged) {
        ...
        setForm({ name: '', description: '', location: '', maxMembers: '', startDate: '', image: '' });
        setSelectedCategory('');
        setCharCount(0);
        setPrivacy('public');
      } else {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      <div className="bg-gradient-to-br from-pink-50 via-indigo-50 to-white rounded-2 shadow-xl p-10 border border-gray-100">
              ...
              <div className="text-center">
                ...
                <div className="text-sm text-gray-600 mt-2">
                  <label htmlFor="image" className="cursor-pointer font-medium text-primary hover:text-primary">
                    ...
                    <input id="image" name="image" type="url" className="sr-only" onChange={handleChange} />
                  </label>
                  <span className="pl-1">or paste image URL</span>
                </div>
