      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 sm:text-4xl dark:text-white">How HobbyHub Works</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {steps.map((step, index) => (
              <div key={index} className="bg-white p-8 rounded-lg shadow-sm text-center dark:bg-gray-800 dark:text-white">
                <div className="w-16 h-16 mx-auto bg-primary/10 rounded-full flex items-center justify-center mb-6 dark:bg-primary/10">
                  <div className="w-8 h-8 flex items-center justify-center text-primary dark:text-white">
                    <i className={`${step.icon} ri-2x`}></i>
                  </div>
                </div>
                <h3 className="text-xl font-semibold text-gray-900 mb-3 dark:text-white">{step.title}</h3>
